...
def you_forgot_something():
    ...
    # Your Answer: = assigns a variable, where == checks if parameters are equal to each other
...
def giving_functions_the_wrong_stuff():
    ...
    my_int_2 = int("549") # What happens if we try to pass a non-number?
